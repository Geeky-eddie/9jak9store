...
import { paystackPay } from "../app/(root)/actions/actions";
...
export default function Donate() {
  ...
  const handleDonate = async (): Promise<void> => {
    ...
    const paystackResponse = await paystackPay({
      ...
      callback_url: "https://geekyeddietech.com", //route where paystack will redirect with reference code after a successful payment
