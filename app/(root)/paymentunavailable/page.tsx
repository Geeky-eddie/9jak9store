...
const PaymentUnavailable: React.FC<PaymentUnavailableProps> = () => {
  return (
    <div className="p-6 text-center items-center bg-black rounded-lg shadow-md">
      ...
      <p className="text-white mt-4 font-semibold">
        This payment method is temporarily unavailable at the moment. <br /> Our team of
        developers are working to get this service up and running for you,
        Kindly use other payment options.
      </p>
    </div>
  );
};
